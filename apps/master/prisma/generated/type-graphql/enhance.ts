...
const modelsInfo = {
  ...
  Tenant: ["id", "name", "createAt", "updateAt", "enable"],
...
const outputsInfo = {
  ...
  TenantGroupBy: ["id", "name", "createAt", "updateAt", "enable", "_count", "_min", "_max"],
  ...
  TenantCount: ["users", "apps"],
  TenantCountAggregate: ["id", "name", "createAt", "updateAt", "enable", "_all"],
  TenantMinAggregate: ["id", "name", "createAt", "updateAt", "enable"],
  TenantMaxAggregate: ["id", "name", "createAt", "updateAt", "enable"],
  AppCount: ["tenants", "users"],
...
const inputsInfo = {
  ...
  TenantWhereInput: ["AND", "OR", "NOT", "id", "name", "createAt", "updateAt", "enable", "users", "apps"],
  TenantOrderByWithRelationInput: ["id", "name", "createAt", "updateAt", "enable", "users", "apps"],
  TenantWhereUniqueInput: ["id"],
  TenantOrderByWithAggregationInput: ["id", "name", "createAt", "updateAt", "enable", "_count", "_max", "_min"],
  TenantScalarWhereWithAggregatesInput: ["AND", "OR", "NOT", "id", "name", "createAt", "updateAt", "enable"],
  AppWhereInput: ["AND", "OR", "NOT", "id", "name", "createAt", "updateAt", "description", "icon", "readmeUrl", "tenants", "users"],
  AppOrderByWithRelationInput: ["id", "name", "createAt", "updateAt", "description", "icon", "readmeUrl", "tenants", "users"],
  ...
  TenantCreateInput: ["id", "name", "createAt", "updateAt", "enable", "users", "apps"],
  TenantUpdateInput: ["id", "name", "createAt", "updateAt", "enable", "users", "apps"],
  TenantUpdateManyMutationInput: ["id", "name", "createAt", "updateAt", "enable"],
  AppCreateInput: ["id", "name", "createAt", "updateAt", "description", "icon", "readmeUrl", "tenants", "users"],
  AppUpdateInput: ["id", "name", "createAt", "updateAt", "description", "icon", "readmeUrl", "tenants", "users"],
  ...
  TenantCountOrderByAggregateInput: ["id", "name", "createAt", "updateAt", "enable"],
  TenantMaxOrderByAggregateInput: ["id", "name", "createAt", "updateAt", "enable"],
  TenantMinOrderByAggregateInput: ["id", "name", "createAt", "updateAt", "enable"],
  TenantListRelationFilter: ["every", "some", "none"],
  TenantOrderByRelationAggregateInput: ["_count"],
  ...
  AppCreateNestedManyWithoutTenantsInput: ["create", "connectOrCreate", "connect"],
  ...
  AppUpdateManyWithoutTenantsNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  TenantCreateNestedManyWithoutAppsInput: ["create", "connectOrCreate", "connect"],
  UserCreateNestedManyWithoutAppsInput: ["create", "connectOrCreate", "connect"],
  TenantUpdateManyWithoutAppsNestedInput: ["create", "connectOrCreate", "upsert", "set", "disconnect", "delete", "connect", "update", "updateMany", "deleteMany"],
  ...
  TenantCreateWithoutUsersInput: ["id", "name", "createAt", "updateAt", "enable", "apps"],
  TenantCreateOrConnectWithoutUsersInput: ["where", "create"],
  AppCreateWithoutUsersInput: ["id", "name", "createAt", "updateAt", "description", "icon", "readmeUrl", "tenants"],
  ...
  TenantUpdateWithoutUsersInput: ["id", "name", "createAt", "updateAt", "enable", "apps"],
  ...
  AppCreateWithoutTenantsInput: ["id", "name", "createAt", "updateAt", "description", "icon", "readmeUrl", "users"],
  AppCreateOrConnectWithoutTenantsInput: ["where", "create"],
  ...
  AppUpsertWithWhereUniqueWithoutTenantsInput: ["where", "update", "create"],
  AppUpdateWithWhereUniqueWithoutTenantsInput: ["where", "data"],
  AppUpdateManyWithWhereWithoutTenantsInput: ["where", "data"],
  TenantCreateWithoutAppsInput: ["id", "name", "createAt", "updateAt", "enable", "users"],
  TenantCreateOrConnectWithoutAppsInput: ["where", "create"],
  UserCreateWithoutAppsInput: ["id", "email", "name", "posts", "username", "password", "tenant"],
  UserCreateOrConnectWithoutAppsInput: ["where", "create"],
  TenantUpsertWithWhereUniqueWithoutAppsInput: ["where", "update", "create"],
  TenantUpdateWithWhereUniqueWithoutAppsInput: ["where", "data"],
  TenantUpdateManyWithWhereWithoutAppsInput: ["where", "data"],
  TenantScalarWhereInput: ["AND", "OR", "NOT", "id", "name", "createAt", "updateAt", "enable"],
  ...
  AppUpdateWithoutUsersInput: ["id", "name", "createAt", "updateAt", "description", "icon", "readmeUrl", "tenants"],
  UserUpdateWithoutTenantInput: ["id", "email", "name", "posts", "username", "password", "apps"],
  AppUpdateWithoutTenantsInput: ["id", "name", "createAt", "updateAt", "description", "icon", "readmeUrl", "users"],
  TenantUpdateWithoutAppsInput: ["id", "name", "createAt", "updateAt", "enable", "users"],
