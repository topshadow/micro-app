...
export default function Home() {
  let [getDate, setDate] = useState<Date | null>();
    ...
    <div className={styles.container}>
      ...
      <main>
        <h1 className={styles.title}>
          ...
          <div>排班时间:{getDate ? getDate.toString() : ''}</div>
          <button onClick={() => eventBus.callTask({ type: 'invoke', command: 'calender' }, (data) => { alert(JSON.stringify(data)); setDate(data.date) })}>打开排班系统</button>
          Welcome to <a href="https://nextjs.org">应用中心!</a>
        </h1>
